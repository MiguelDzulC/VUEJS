          ...
          <svg width="100%" height="100%" viewBox="0 0 500 150" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="
            ...
            <g>
              <g>
                <g>
                  <g id="Capa2">
                    <path d="M82.775,89.986l-9.562,-15.753l-18.702,-0.24c0,0 9.563,15.754 9.563,15.754l18.701,0.239Z" style="fill: none; stroke: #AE01D6; stroke-width: 6px"></path>
                    <path d="M45.378,89.504l9.133,-15.511c0,0 9.563,15.755 9.563,15.754c0,0.001 -9.135,15.509 -9.135,15.509l-9.561,-15.752Z" style="fill: none; stroke: #AE01D6; stroke-width: 6px"></path>
                    <path d="M64.074,89.747l-9.135,15.509l18.697,0.245l9.139,-15.515l-18.701,-0.239Z" style="fill: none; stroke: #AE01D6; stroke-width: 6px"></path>
                  </g>
              ...
              <path d="M295.381,105.999l-0,-43.063l-7.193,-0l-0,50.256l38.805,0l0,-7.193l-31.612,0Z" style="fill: #AE01D6; fill-rule: nonzero"></path>
              <path d="M342.272,113.192l9.502,0l15.817,-28.582l-4.726,-8.622l-20.593,37.204Zm32.452,-41.464l-4.752,-8.584l-0.003,0.005l-4.747,8.579l22.948,41.464l9.504,0l-22.95,-41.464Z" style="fill: #AE01D6; fill-rule: nonzero"></path>
